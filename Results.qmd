...
Extraversion differed between those who volunteered. As shown in the table above, volunteers were more extraverted on average than those who did not volunteer.

However, scores on neuroticism did not differ between groups.
...
lmtest <- lm(neuroticism ~ extraversion * volunteer, data = Cowles)

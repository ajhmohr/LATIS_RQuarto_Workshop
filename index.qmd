...
This is a book created from markdown [@rmarkdown] and executable code.

See @knuth84 for additional discussion of literate programming. <!--# Add discussion of other programming tools here -->
